...
const LANGS = {
  ru: {
    ...
    priv_s5_li:'<li><strong>Право на доступ (ст. 15)</strong> — Все данные хранятся локально на вашем устройстве; вы можете просмотреть их в localStorage браузера.</li><li><strong>Право на исправление (ст. 16)</strong> — Историю расчётов можно редактировать или удалять прямо в приложении.</li><li><strong>Право на удаление (ст. 17)</strong> — Удалите все данные через функцию «Очистить историю» или в настройках браузера.</li><li><strong>Право на ограничение обработки (ст. 18)</strong> — Очистите запись о согласии (ключ localStorage: <code>terms_accepted_ver</code>) и не принимайте Условия повторно.</li><li><strong>Право на переносимость (ст. 20)</strong> — Экспортируйте историю через функции «Копировать» или «Поделиться».</li><li><strong>Право на отзыв согласия (ст. 7(3))</strong> — Отзовите согласие в любое время, очистив localStorage. Отзыв не влияет на законность предыдущей обработки.</li><li><strong>Право на возражение (ст. 21)</strong> — Заблокируйте аналитику Plausible с помощью блокировщика рекламы.</li><li><strong>Право на жалобу</strong> — Вы можете подать жалобу в Польский надзорный орган: UODO, ул. Ставки 2, 00-193 Варшава. <a href="https://uodo.gov.pl" target="_blank" rel="noopener">uodo.gov.pl</a></li>',
  ...
  en: {
    ...
    priv_s5_li:'<li><strong>Right of access (Art. 15)</strong> — All data is stored locally on your device; you can inspect it directly in your browser\'s localStorage.</li><li><strong>Right to rectification (Art. 16)</strong> — Calculation history can be edited or deleted directly within the Application.</li><li><strong>Right to erasure (Art. 17)</strong> — Delete all data at any time using the "Clear History" function, or by clearing localStorage in your browser settings.</li><li><strong>Right to restriction of processing (Art. 18)</strong> — Restrict processing by clearing your consent record (localStorage key: <code>terms_accepted_ver</code>) and not re-accepting the Terms.</li><li><strong>Right to data portability (Art. 20)</strong> — Export your calculation history using the "Copy" or "Share" function.</li><li><strong>Right to withdraw consent (Art. 7(3))</strong> — Withdraw consent at any time by clearing localStorage. Withdrawal does not affect the lawfulness of prior processing.</li><li><strong>Right to object (Art. 21)</strong> — Object to analytics data collection (Plausible) by using browser-level ad/tracker blockers.</li><li><strong>Right to lodge a complaint</strong> — Lodge a complaint with the Polish supervisory authority: UODO, ul. Stawki 2, 00-193 Warsaw. <a href="https://uodo.gov.pl" target="_blank" rel="noopener">uodo.gov.pl</a></li>',
  ...
  es: {
    ...
    priv_s5_li:'<li><strong>Derecho de acceso (Art. 15)</strong> — Todos los datos se almacenan localmente en su dispositivo; puede inspeccionarlos en el localStorage del navegador.</li><li><strong>Derecho de rectificación (Art. 16)</strong> — El historial puede editarse o eliminarse directamente en la aplicación.</li><li><strong>Derecho de supresión (Art. 17)</strong> — Elimine todos los datos con «Borrar historial» o en la configuración del navegador.</li><li><strong>Derecho de limitación (Art. 18)</strong> — Borre su registro de consentimiento (clave localStorage: <code>terms_accepted_ver</code>).</li><li><strong>Derecho de portabilidad (Art. 20)</strong> — Exporte su historial usando «Copiar» o «Compartir».</li><li><strong>Derecho a retirar el consentimiento (Art. 7(3))</strong> — Retire el consentimiento borrando el localStorage.</li><li><strong>Derecho de oposición (Art. 21)</strong> — Bloquee el análisis de Plausible con un bloqueador de anuncios.</li><li><strong>Derecho de reclamación</strong> — Presente una reclamación ante la autoridad de control: UODO en Polonia, AEPD en España. <a href="https://uodo.gov.pl" target="_blank" rel="noopener">uodo.gov.pl</a></li>',
  ...
  de: {
    ...
    priv_s5_li:'<li><strong>Auskunftsrecht (Art. 15)</strong> — Alle Daten werden lokal auf Ihrem Gerät gespeichert; Sie können sie direkt im localStorage Ihres Browsers einsehen.</li><li><strong>Berichtigungsrecht (Art. 16)</strong> — Die Berechnungshistorie kann direkt in der App bearbeitet oder gelöscht werden.</li><li><strong>Löschungsrecht (Art. 17)</strong> — Löschen Sie alle Daten mit der Funktion „Verlauf löschen" oder in den Browsereinstellungen.</li><li><strong>Recht auf Verarbeitungseinschränkung (Art. 18)</strong> — Löschen Sie Ihren Einwilligungseintrag (localStorage-Schlüssel: <code>terms_accepted_ver</code>) und akzeptieren Sie die Bedingungen nicht erneut.</li><li><strong>Recht auf Datenübertragbarkeit (Art. 20)</strong> — Exportieren Sie Ihre Historie über „Kopieren" oder „Teilen".</li><li><strong>Recht auf Widerruf (Art. 7(3))</strong> — Widerrufen Sie die Einwilligung jederzeit durch Löschen des localStorage.</li><li><strong>Widerspruchsrecht (Art. 21)</strong> — Blockieren Sie Plausible-Analysen mit einem Werbeblocker.</li><li><strong>Beschwerderecht</strong> — Beschwerde beim polnischen Datenschutzbeauftragten: UODO, ul. Stawki 2, 00-193 Warschau. <a href="https://uodo.gov.pl" target="_blank" rel="noopener">uodo.gov.pl</a></li>',
  ...
  fr: {
    ...
    priv_s5_li:'<li><strong>Droit d\'accès (Art. 15)</strong> — Toutes les données sont stockées localement sur votre appareil; vous pouvez les consulter dans le localStorage de votre navigateur.</li><li><strong>Droit de rectification (Art. 16)</strong> — L\'historique peut être modifié ou supprimé directement dans l\'application.</li><li><strong>Droit à l\'effacement (Art. 17)</strong> — Supprimez toutes les données via «Effacer l\'historique» ou dans les paramètres du navigateur.</li><li><strong>Droit à la limitation (Art. 18)</strong> — Effacez votre enregistrement de consentement (clé localStorage: <code>terms_accepted_ver</code>).</li><li><strong>Droit à la portabilité (Art. 20)</strong> — Exportez votre historique via «Copier» ou «Partager».</li><li><strong>Droit de retrait du consentement (Art. 7(3))</strong> — Retirez votre consentement à tout moment en effaçant le localStorage.</li><li><strong>Droit d\'opposition (Art. 21)</strong> — Bloquez l\'analyse Plausible avec un bloqueur de publicités.</li><li><strong>Droit de réclamation</strong> — Déposez une plainte auprès de l\'autorité de contrôle: UODO en Pologne, CNIL en France. <a href="https://uodo.gov.pl" target="_blank" rel="noopener">uodo.gov.pl</a></li>',
  ...
  be: {
    ...
    priv_s5_li:'<li><strong>Права доступу (арт. 15)</strong> — Усе даныя захоўваюцца лакальна на вашай прыладзе.</li><li><strong>Права на выпраўленне (арт. 16)</strong> — Гісторыю разлікаў можна рэдагаваць або выдаляць у прыкладанні.</li><li><strong>Права на выдаленне (арт. 17)</strong> — Выдаліце ​​ўсе даныя праз «Ачысціць гісторыю» або ў наладах браўзера.</li><li><strong>Права на абмежаванне апрацоўкі (арт. 18)</strong> — Ачысціце запіс аб згодзе (ключ localStorage: <code>terms_accepted_ver</code>).</li><li><strong>Права на пераноснасць (арт. 20)</strong> — Экспартуйце гісторыю праз «Капіяваць» або «Падзяліцца».</li><li><strong>Права на адклік згоды (арт. 7(3))</strong> — Адклічце згоду ў любы момант праз ачыстку localStorage.</li><li><strong>Права на пярэчанне (арт. 21)</strong> — Заблакіруйце аналітыку Plausible блакіроўшчыкам рэкламы.</li><li><strong>Права на скаргу</strong> — Падайце скаргу ў UODO, Варшава. <a href="https://uodo.gov.pl" target="_blank" rel="noopener">uodo.gov.pl</a></li>',
  ...
  zh: {
    ...
    priv_s5_li:'<li><strong>访问权（第15条）</strong> — 所有数据均本地存储在您的设备上；您可以直接在浏览器localStorage中查看。</li><li><strong>更正权（第16条）</strong> — 可以直接在应用中编辑或删除计算历史。</li><li><strong>删除权（第17条）</strong> — 使用"清除历史"功能或在浏览器设置中随时删除所有数据。</li><li><strong>限制处理权（第18条）</strong> — 清除同意记录（localStorage键：<code>terms_accepted_ver</code>）。</li><li><strong>数据可携带权（第20条）</strong> — 使用"复制"或"分享"功能导出计算历史。</li><li><strong>撤回同意权（第7(3)条）</strong> — 随时通过清除localStorage撤回同意。</li><li><strong>反对权（第21条）</strong> — 使用广告拦截器阻止Plausible分析。</li><li><strong>投诉权</strong> — 可向波兰监管机构投诉：UODO。<a href="https://uodo.gov.pl" target="_blank" rel="noopener">uodo.gov.pl</a></li>',
