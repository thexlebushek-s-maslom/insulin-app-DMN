...
const LANGS = {
  ru: {
    ...
    terms_s07_plain:'Данное Приложение <strong>не предназначено для лиц до 16 лет</strong> без непосредственного контроля родителя или опекуна. Использование лицами до 16 лет без такого контроля запрещено. Разработчик не несёт ответственности за вред, причинённый несанкционированным использованием несовершеннолетними.',
    terms_s07_legal:'Приложение не предназначено для использования лицами младше 16 лет без непосредственного контроля родителя или законного опекуна. Разработчик не допускает использования несовершеннолетними без надзора и не несёт ответственности за ущерб, возникший вследствие несанкционированного использования несовершеннолетними.',
  ...
  en: {
    ...
    terms_date:'Last updated: 25 March 2026 &middot; Version 1.2',
    ...
    terms_s07_plain:'This App is <strong>not intended for persons under 16</strong> without direct parental or guardian supervision. Use by under-16s without supervision is prohibited. The developer assumes no liability for harm from unauthorised use by a minor.',
    terms_s07_legal:'The Application is not intended for use by persons under the age of 16 without direct supervision of a parent or legal guardian. The developer does not knowingly permit unsupervised use by minors and assumes no liability for any harm arising from unauthorised use by a minor.',
  ...
  es: {
    ...
    terms_s07_plain:'Esta Aplicación <strong>no está destinada a personas menores de 16 años</strong> sin supervisión directa de un padre o tutor. El uso por menores de 16 años sin dicha supervisión está prohibido.',
    terms_s07_legal:'La Aplicación no está destinada al uso por personas menores de 16 años sin supervisión directa de un padre o tutor legal. El desarrollador no permite el uso no supervisado por menores y no asume responsabilidad por daños derivados del uso no autorizado por un menor.',
  ...
  de: {
    ...
    terms_date:'Zuletzt aktualisiert: 25. März 2026 &middot; Version 1.2',
    ...
    terms_s07_plain:'Diese Anwendung ist <strong>nicht für Personen unter 16 Jahren</strong> ohne direkte elterliche Aufsicht bestimmt. Die Nutzung durch unter 16-Jährige ohne Aufsicht ist untersagt.',
    terms_s07_legal:'Die Anwendung ist nicht für die Nutzung durch Personen unter 16 Jahren ohne direkte Aufsicht eines Elternteils oder gesetzlichen Vormunds bestimmt. Der Entwickler übernimmt keine Haftung für Schäden durch unbefugte Nutzung durch Minderjährige.',
  ...
  fr: {
    ...
    terms_date:'Dernière mise à jour : 25 mars 2026 &middot; Version 1.2',
    ...
    terms_s07_plain:'Cette Application <strong>n\'est pas destinée aux personnes de moins de 16 ans</strong> sans supervision directe d\'un parent ou tuteur. L\'utilisation par les moins de 16 ans sans supervision est interdite.',
    terms_s07_legal:'L\'Application n\'est pas destinée à une utilisation par des personnes de moins de 16 ans sans la supervision directe d\'un parent ou d\'un tuteur légal. Le développeur ne permet pas l\'utilisation non supervisée par des mineurs et décline toute responsabilité pour les dommages résultant d\'une utilisation non autorisée par un mineur.',
  ...
  be: {
    ...
    terms_s07_plain:'Дадзенае Прыкладанне <strong>не прызначана для асоб да 16 гадоў</strong> без непасрэднага нагляду бацькоў або апекуна. Выкарыстанне асобамі да 16 гадоў без такога нагляду забаронена.',
    terms_s07_legal:'Прыкладанне не прызначана для выкарыстання асобамі малодшымі за 16 гадоў без непасрэднага нагляду бацькі або законнага апекуна. Распрацоўшчык не нясе адказнасці за шкоду, прычыненую несанкцыянаваным выкарыстаннем непаўналетнімі.',
  ...
  zh: {
    ...
    terms_s07_plain:'本应用程序<strong>不适合16岁以下</strong>未经父母或监护人直接监督的人士使用。16岁以下人士未经监督使用被禁止。',
    terms_s07_legal:'本应用程序不适合16岁以下人士在未经父母或法定监护人直接监督的情况下使用。开发者不knowingly允许未成年人无监督使用，对未成年人未经授权使用造成的伤害不承担责任。',
